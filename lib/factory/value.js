...
exports.create = function (valStr) {
  ...
  var variable = tree.body[0]['w:Members'][0]['f:SingletonList<MemberDeclarationSyntax>'][0]['f:FieldDeclaration'][0].b[0]['w:Variables'][0]['f:SingletonSeparatedList<VariableDeclaratorSyntax>'][0];
