...
function syntaxList(type, array) {
  ...
  if (!_.isArray(array) || array.length == 1) {
    var obj = {};
    obj['f:SingletonList<' + type + '>'] = (_.isArray(array) ? array : [array]);
    return obj;
  }
  var obj2 = {};
  obj2['n:' + type] = array;
...
function syntaxSeperatedList(type, array) {
  ...
  if (!_.isArray(array) || array.length == 1) {
    var obj = {};
    obj['f:SingletonSeparatedList<' + type + '>'] = (_.isArray(array) ? array : [array]);
    return obj;
  }
  var array2 = [array[0]];
  ...
  var obj2 = {};
  obj2['n:SyntaxNodeOrToken'] = array2;
  var obj = {};
  obj['f:SeparatedList<' + type + '>'] = [obj2];
  return obj;
}