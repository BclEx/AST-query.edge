...
function syntaxFqdn(name) {
  var args = _.split(name, '.');
  var array = _.map(args, function (arg) {
    return { 'f:IdentifierName': [arg] };
  });
  var r = array[0];
  for (var i = 1, l = array.length; i < l; i++) {
    r = { 'f:QualifiedName': [r, array[i]] };
  }
  return r;
}
