    ...
    ast = {
      'f:FieldDeclaration': [{
        'f:VariableDeclaration': [this.getMemberType()], b: [
          { 'w:Variables': [{ "f:SingletonSeparatedList<VariableDeclaratorSyntax>": [{ 'f:VariableDeclarator': [{ 'f:Identifier': [memberName] }] }] }] }]
      }], b: [
        ...
        'w:ArgumentList': [{
          'f:AttributeArgumentList': [{
            'f:SingletonSeparatedList<AttributeArgumentSyntax>': [{
              'f:AttributeArgument': [{ 'f:LiteralExpression': [{ 'k:StringLiteralExpression': null }, { 'f:Literal': [values[0]] }] }]
            }]
          }], b: []
        }]
      }]
