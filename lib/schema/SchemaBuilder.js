...
_.each(['addUsing', 'createClass', 'createClassIfNotExists', 'class', 'alterClass',
  'dropClass', 'dropClassIfExists', 'renameClass', 'raw'], function (method) {
...
SchemaBuilder.prototype.toAST = function () {
  return this.tree.alter(this.tree.schemaCompiler(this).toAST());
};
